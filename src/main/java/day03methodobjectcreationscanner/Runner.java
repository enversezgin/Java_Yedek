...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Teacher mehmterHoca = new Teacher();
        System.out.println("mehmterHoca.isim = " + mehmterHoca.isim);
        System.out.println("mehmterHoca.yas = " + mehmterHoca.yas);
        mehmterHoca.teach();
...
//homework
//icinde isim ve yas varibale lari ile teach methodu bulunan bir
// Teacher objecti olusturun ve obje uzerinde bu ozellikleri
// kullanini