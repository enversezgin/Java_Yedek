...
public class IncrementDecrement {
    public static void main(String[] args) {
        ...
        System.out.println("k : "+k);//10 ==> i artirilmadan "k" ya konuldugu icin "k" nin degeri 10 olur
        System.out.println("i : "+i);//11 ==> i satir sonunda artirildigi icin 1 nin degeri 11 olur
