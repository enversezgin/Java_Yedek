...
public class Tekrar_StringManipulation02 {
    public static void main(String[] args) {
        //Ornek 1:  Bir string in belirli bir karakterinden baslayarak belirli bir karaktere kadar dynamic olarak aliniz
        //      abc@gmail.com   ===> gmail

        String a = "abcdef123ghei@softmail.com";
        int index_At = a.indexOf('@');          // 10
        int indexPoint = a.indexOf('.');        // 18
        String eMailComp = a.substring(index_At+1,indexPoint);
        ...
        boolean st = s==t ;
        System.out.println("st = " + st);//false cunku adresler ve degerler farklidir
        boolean stEqu = s.equals(t);
        System.out.println("stEqu = " + stEqu);//false cunku degerler farkli
        System.out.println(s==r); //false cunku adresler farkli
        System.out.println(s.equalsIgnoreCase(r));//true cunku equals() sadece degerlere bakar."s" ve "r" nin degerleri ayni oldugunda true verir
//___________________________________________________________________________________________________________________________
